...
//申请到的appkey
$_SESSION["appkey"]   = "6708b6168a1f4e7bbdeab88b9c547b3b"; 

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
$_SESSION["callback"] = "www.jsd001.com/includes/forQQLogin_get_access_token.php"; 

//QQ授权api接口.按需调用
$_SESSION["scope"] = "get_user_info,add_t,get_info";
